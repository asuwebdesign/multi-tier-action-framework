    ...
    <>
      ...
      <section className="page-section">
        ...
        <p className="page-section-intro">
          Real-time status indicators for AI agent operations, providing immediate visual feedback on action states.
        </p>
        <div className="page-content-container">
          <div>
            <div className="variant-description">
              ...
              <p>
                Indicates an ongoing operation where the AI agent is actively processing a request or waiting for a response.
              </p>
            </div>
            ...
            <ExpandableSection
              toggleText={expandedCode['status-loading'] ? 'Hide code' : 'Show code'}
              onToggle={() => toggleCode('status-loading')}
              isExpanded={expandedCode['status-loading']}
              className="code-expandable"
            >
              <SyntaxHighlighter language="tsx" style={isDarkMode ? oneDark : oneLight} customStyle={{ borderRadius: '4px' }}>
                {`<ToolStatus variant="loading" label="Analyzing data" />`}
              </SyntaxHighlighter>
            </ExpandableSection>
          </div>
          ...
          <div>
            <div className="variant-description">
              ...
              <p>
                Confirms successful completion of an AI agent action, signaling that the operation finished without errors.
              </p>
            </div>
            <div className="status-frame">
            ...
            <ExpandableSection
              toggleText={expandedCode['status-success'] ? 'Hide code' : 'Show code'}
          ...
          <div>
            <div className="variant-description">
              ...
              <p>
                Alerts when an AI agent action has failed or been rejected, requiring user attention or intervention.
              </p>
            </div>
            <div className="status-frame">
            ...
            <ExpandableSection
              toggleText={expandedCode['status-error'] ? 'Hide code' : 'Show code'}
      ...
      <section className="page-section">
        <h2>Tool Cards</h2>
        <p className="page-section-intro">
          Tiered approval interface for AI agent actions, with progressive governance based on risk level and impact scope.
        </p>
        <div className="page-variant-container">
          <div>
            <div className="tier-description">
              ...
              <p>
                Low-risk actions involving external API calls or data retrieval. Requires user awareness but minimal oversight,
                typically for read-only operations outside the private environment.
              </p>
            </div>
            ...
            <ExpandableSection
              toggleText={expandedCode['tool-info'] ? 'Hide code' : 'Show code'}
...
/>`}
          ...
          <div>
            <div className="tier-description">
              ...
              <p>
                Medium-risk actions that modify system state or configuration. Requires user review and explicit approval
                before the AI agent can proceed with changes that affect the environment.
              </p>
            </div>
            <div className="card-frame">
              <ToolCard
            ...
            <ExpandableSection
              toggleText={expandedCode['tool-warning'] ? 'Hide code' : 'Show code'}
...
/>`}
          ...
          <div>
            <div className="tier-description">
              ...
              <p>
                High-risk actions with potentially destructive or irreversible consequences. Requires explicit acknowledgment
                via checkbox confirmation, ensuring users understand the gravity before the AI agent executes critical operations.
              </p>
            </div>
            <div className="card-frame">
              <ToolCard
            ...
            <ExpandableSection
              toggleText={expandedCode['tool-danger'] ? 'Hide code' : 'Show code'}
